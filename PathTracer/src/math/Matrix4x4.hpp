...
namespace Guarneri {
	...
	Matrix4x4::Matrix4x4(const float& _m00, const float& _m01, const float& _m02, const float& _m03,
			  const float& _m10, const float& _m11, const float& _m12, const float& _m13,
			  const float& _m20, const float& _m21, const float& _m22, const float& _m23,
			  const float& _m30, const float& _m31, const float& _m32, const float& _m33)
	{
	...
	Matrix4x4 Matrix4x4::rotation(const Vector3& axis, const float& theta)
	{
	...
	Matrix4x4 Matrix4x4::lookat(const Vector3& eye, const Vector3& target, const Vector3& world_up)
	{
	#ifdef LEFT_HANDED
	...
	Matrix4x4 Matrix4x4::lookat_lh(const Vector3& eye, const Vector3& target, const Vector3& world_up)
	{
	...
	Matrix4x4 Matrix4x4::lookat_rh(const Vector3& eye, const Vector3& target, const Vector3& world_up)
	{
		Vector3 forward = Vector3::normalize(target - eye);
	...
	Matrix4x4 Matrix4x4::perspective_rh_dx(const float& fov, const float& aspect, const float& near, const float& far)
	{
	...
	Matrix4x4 Matrix4x4::perspective_lh_dx(const float& fov, const float& aspect, const float& near, const float& far)
	{
		float rad = DEGREE2RAD(fov * 0.5f);
		float cot = std::cos(rad) / std::sin(rad);
		Matrix4x4 m = ZERO;
	...
	Matrix4x4 Matrix4x4::perspective_rh_gl(const float& fov, const float& aspect, const float& near, const float& far)
	{
		float rad = DEGREE2RAD(fov * 0.5f);
		float cot = std::cos(rad) / std::sin(rad);
		Matrix4x4 m = ZERO;
	...
	Matrix4x4 Matrix4x4::perspective_lh_gl(const float& fov, const float& aspect, const float& near, const float& far)
	{
		float rad = DEGREE2RAD(fov * 0.5f);
		float cot = std::cos(rad) / std::sin(rad);
		Matrix4x4 m = ZERO;
	...
	Matrix4x4 Matrix4x4::ortho_rh_dx(const float& left, const float& right, const float& bottom, const float& top, const float& near, const float& far)
	{
		Matrix4x4 m = IDENTITY;
	...
	Matrix4x4 Matrix4x4::ortho_lh_dx(const float& left, const float& right, const float& bottom, const float& top, const float& near, const float& far)
	{
		Matrix4x4 m = IDENTITY;
		m.at(0, 0) = 2.0f / (right - left);
		m.at(1, 1) = 2.0f / (top - bottom);
	...
	Matrix4x4 Matrix4x4::ortho_rh_gl(const float& left, const float& right, const float& bottom, const float& top, const float& near, const float& far)
	{
		Matrix4x4 m = IDENTITY;
		m.at(0, 0) = 2.0f / (right - left);
		m.at(1, 1) = 2.0f / (top - bottom);
	...
	Matrix4x4 Matrix4x4::ortho_lh_gl(const float& left, const float& right, const float& bottom, const float& top, const float& near, const float& far)
	{
		Matrix4x4 m = IDENTITY;
		m.at(0, 0) = 2.0f / (right - left);
		m.at(1, 1) = 2.0f / (top - bottom);
	...
	Vector3 Matrix4x4::transform_point(const Vector3& point) const
	{
		Vector3 ret;
	...
	Vector3 Matrix4x4::transform_direction(const Vector3& point) const
	{
		Vector3 ret;
	...
	const float& Matrix4x4::at(const int& row, const int& column) const
	{
		return this->operator[](rc2index(row, column));
	}

	float& Matrix4x4::at(const int& row, const int& column)
	{
		return this->operator[](rc2index(row, column));
	}
